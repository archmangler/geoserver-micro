...
wms_url = "http://localhost:8080/geoserver/wms/service"
...
print(wms.contents['tiger:poi'].boundingBox)

print(wms.contents['tiger:poi'].boundingBoxWGS84)

#3. Get styles
print(wms.contents['tiger:poi'].styles)
